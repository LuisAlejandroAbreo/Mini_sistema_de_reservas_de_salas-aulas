...
El sistema tiene como objetivo principal permitir **la gestión básica de reservas de salas y aulas de forma clara y centralizada**, Asegurando que no existan conflictos de horario en una misma sala.
